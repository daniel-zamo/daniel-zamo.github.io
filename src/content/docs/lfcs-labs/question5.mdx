...
candidate@data-001-lab1:~$ whoami
candidate@data-001-lab1:~$ cd /imports/
candidate@data-001-lab1:/imports$ ls -al
candidate@data-001-lab1:/imports$ bunzip2 -k import001.tar.bz2 
candidate@data-001-lab1:/imports$ ls
candidate@data-001-lab1:/imports$ gzip --best import001.tar
candidate@data-001-lab1:/imports$ ls -lh
candidate@data-001-lab1:/imports$tar -tvjf import001.tar.bz2|sort > import001.tar.bz2_list
candidate@data-001-lab1:/imports$tar -tvzf import001.tar.gz|sort > import001.tar.gz_list
# Compare the two lists to ensure they are identical
candidate@data-001-lab1:/imports$ diff import001.tar.gz_list import001.tar.bz2_list
# View the contents of one of the lists 
candidate@data-001-lab1:/imports$ cat import001.tar.gz_list
...
...
candidate@data-001-lab1:/imports$
```
</details>
