...
<div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-top: 1rem;">
    <LinkButton href="/en/az-cloud-ops/compute/scenario-01-lamp-iaas/" variant="primary" icon="rocket">
        View Scenario 01: LAMP Stack IaaS
    </LinkButton>
    <LinkButton href="/en/az-cloud-ops/networking/scenario-02-vnet-tiers/" variant="primary" icon="rocket">
    View Scenario 02: Isolated VNET Tiers
</LinkButton>
</div>
