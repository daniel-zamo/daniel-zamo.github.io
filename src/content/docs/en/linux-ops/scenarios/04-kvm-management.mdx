---
title: "KVM/Libvirt VM Orchestration" # BEFORE: Lab 04
...
**Context:** The QA team requests an isolated compute instance on the `kvm-001` hypervisor for integration testing.

**Engineering Objectives:**
1.  **Host Readiness:** Ensure operational status of the `qemu-kvm` and `libvirtd` stack.
2.  **Storage Provisioning:** Create `qcow2` volumes utilizing Thin Provisioning.
3.  **Instance Definition:** Deploy a `headless` guest with serial console redirection for management without a GUI.
