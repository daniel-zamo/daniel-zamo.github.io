---
title: "Estrategia de Backup WSL 2: Grandes Volúmenes (>2GB)"
description: "Resolución de errores de exportación de instancias pesadas y corrección de sintaxis para 7-Zip en PowerShell."
date: 2026-01-30
category: "sop"
...
graph TD
    ...
    SD --> Exp[wsl --export]
    Exp --> Size{¿Tamaño > 2GB?}
    Size -- Sí --> Tool[7-Zip / ZIP64]
    Size -- No --> Native[Compress-Archive]
    Tool --> Syntax[Sintaxis: Separación por ESPACIOS]
...
<CardGrid>
  ...
  <LinkCard 
    ...
    description="Script para verificar el tamaño final en GB." 
...
---
**Generado por:** dzamo-sysadmin | **Versión:** 1.0 | **Sintaxis:** Verificada en PS7
