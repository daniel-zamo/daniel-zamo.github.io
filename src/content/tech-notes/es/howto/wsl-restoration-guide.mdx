---
title: "Restauración y Despliegue de Instancias WSL 2"
description: "Protocolo de reconstrucción de entornos Linux a partir de artefactos .tar tras una migración de sistema o fallo de hardware."
...
graph TD
    ...
    B --> C[Asignación de VHDX]
    C --> D[Configuración Identity]
    D --> E[Optimización Sparse]
