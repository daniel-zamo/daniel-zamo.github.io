# Tecnología de k8s que incluye el CKA

La **CKA** es sobre **Kubernetes "Vanilla" (puro)**.
...
Aquí tienes los 5 dominios que la Linux Foundation evalúa, con los temas específicos que debes dominar en tu laboratorio:

#### 1. Cluster Architecture, Installation & Configuration (25%)
Este es el bloque donde usas tu Host con Rocky Linux para crear VMs.
...
*   **Taints & Tolerations / Node Affinity:** Controlar en qué nodo cae cada Pod (tienes dos hosts físicos, así que practica moviendo pods de la Laptop al Host Fijo).
